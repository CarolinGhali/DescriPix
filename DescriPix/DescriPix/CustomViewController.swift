...
class CustomViewController: Mantis.CropViewController {
    ...
    @objc private func onDescribeClicked() {
        ...
        DispatchQueue.main.async {
            ...
            let questions = ["Describe this image accurately", "What is there in this area?", "What is in the foreground?", "What is in the background?", "Provide a morphological description", "Describe the colors in this area","Custom question"]
    ...
    private func uploadingImage(image: UIImage, question: String) {
        uploadImage(selectedImage: image, text: question) { generatedText in
